<template>
	...
	<BlockUI>
		...
		<p>This page contains paywalled content.
			Please make a <a :href="raiden_payment.url" target="_blank" rel="noopener noreferrer">Raiden payment</a>
		...
		<p>
			The Raiden payment timed out. Please reload the page and make required payments.
		</p>
		</div>
	</BlockUI>
</div>
